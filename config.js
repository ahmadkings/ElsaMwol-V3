...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By ElsaMwol' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '917736703116@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    YAK: process.env.YAK === undefined ? '917736703116,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
